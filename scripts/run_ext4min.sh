...
do
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/fileserver_1T_400kF.f > results/ext4min/fileserver_1T_400kF.f_${i}"
	filebench -f workloads/ext4min/fileserver_1T_400kF.f > results/ext4min/fileserver_1T_400kF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/fileserver_2T_400kF.f > results/ext4min/fileserver_2T_400kF.f_${i}"
	filebench -f workloads/ext4min/fileserver_2T_400kF.f > results/ext4min/fileserver_2T_400kF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/fileserver_4T_400kF.f > results/ext4min/fileserver_4T_400kF.f_${i}"
	filebench -f workloads/ext4min/fileserver_4T_400kF.f > results/ext4min/fileserver_4T_400kF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/fileserver_8T_400kF.f > results/ext4min/fileserver_8T_400kF.f_${i}"
	filebench -f workloads/ext4min/fileserver_8T_400kF.f > results/ext4min/fileserver_8T_400kF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/varmail_1T_1mF.f > results/ext4min/varmail_1T_1mF.f_${i}"
	filebench -f workloads/ext4min/varmail_1T_1mF.f > results/ext4min/varmail_1T_1mF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/varmail_2T_1mF.f > results/ext4min/varmail_2T_1mF.f_${i}"
	filebench -f workloads/ext4min/varmail_2T_1mF.f > results/ext4min/varmail_2T_1mF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/varmail_4T_1mF.f > results/ext4min/varmail_4T_1mF.f_${i}"
	filebench -f workloads/ext4min/varmail_4T_1mF.f > results/ext4min/varmail_4T_1mF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/varmail_8T_1mF.f > results/ext4min/varmail_8T_1mF.f_${i}"
	filebench -f workloads/ext4min/varmail_8T_1mF.f > results/ext4min/varmail_8T_1mF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/webproxy_1T_1mF.f > results/ext4min/webproxy_1T_1mF.f_${i}"
	filebench -f workloads/ext4min/webproxy_1T_1mF.f > results/ext4min/webproxy_1T_1mF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/webproxy_2T_1mF.f > results/ext4min/webproxy_2T_1mF.f_${i}"
	filebench -f workloads/ext4min/webproxy_2T_1mF.f > results/ext4min/webproxy_2T_1mF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/webproxy_4T_1mF.f > results/ext4min/webproxy_4T_1mF.f_${i}"
	filebench -f workloads/ext4min/webproxy_4T_1mF.f > results/ext4min/webproxy_4T_1mF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/webproxy_8T_1mF.f > results/ext4min/webproxy_8T_1mF.f_${i}"
	filebench -f workloads/ext4min/webproxy_8T_1mF.f > results/ext4min/webproxy_8T_1mF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/webserver_1T_500kF.f > results/ext4min/webserver_1T_500kF.f_${i}"
	filebench -f workloads/ext4min/webserver_1T_500kF.f > results/ext4min/webserver_1T_500kF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/webserver_2T_500kF.f > results/ext4min/webserver_2T_500kF.f_${i}"
	filebench -f workloads/ext4min/webserver_2T_500kF.f > results/ext4min/webserver_2T_500kF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/webserver_4T_500kF.f > results/ext4min/webserver_4T_500kF.f_${i}"
	filebench -f workloads/ext4min/webserver_4T_500kF.f > results/ext4min/webserver_4T_500kF.f_${i}
	rm -rf /mnt/ext4min/*
	...
	rm -rf /mnt/ext4min/*
	echo "	filebench -f workloads/ext4min/webserver_8T_500kF.f > results/ext4min/webserver_8T_500kF.f_${i}"
	filebench -f workloads/ext4min/webserver_8T_500kF.f > results/ext4min/webserver_8T_500kF.f_${i}
	rm -rf /mnt/ext4min/*
 done